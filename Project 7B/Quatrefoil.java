...
public class Quatrefoil implements Comparable<Quatrefoil> {
   ...
   /**
    * Method that compares the areas from two different Quatrefoil objects.
       * @param obj Quatrefoil object compared to this Quatrefoil object.
       * @return 0, -1, 1 depending on the comparison of areas.
    */
