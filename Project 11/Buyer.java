...
public abstract class Buyer implements Comparable<Buyer> {
   ...
   */
   ...
   /**
    * Method that compares the name of the buyers and sorts it accordingly.
    * @param other Inputted parameter object of type Buyer that is compared.
    * @return -1, 0, -1 depending on what the outcome of the comparison is.
    */
